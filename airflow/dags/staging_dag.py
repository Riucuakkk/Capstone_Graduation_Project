...
with DAG(
    ...
    trigger_vault = TriggerDagRunOperator(
        task_id="trigger_vault_pipeline",
        trigger_dag_id="vault_pipeline",
    )
    ...
    start >> dbt_staging >> end >> trigger_vault

    [dbt_staging, trigger_vault] >> notify_failure
    trigger_vault >> notify_success
